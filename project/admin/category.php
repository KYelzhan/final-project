            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-left">
                   <li><a href="home.php"> Приборная панель</a></li>
                    <li><a href="post.php"> Все задания</a></li>
    ...
    <div class="container" style="margin:8% auto;width:900px;">
            <div class="panel panel-success">
                <div class="panel-heading">
                 ...
                 <div class="panel-body">
                     <a href="add-category.php" class="pull-right btn btn-success">Добавить</a><br><br>
            <table class="table table-stripped">
                            ...
                            while($row=mysql_fetch_array($run))
                            {
                                ...
                                echo "<tr>";
                                echo "<td>".$category."</td>";
                                echo '<td><a href="edit-category.php?cat_id='.$cat_id.'"><button class="btn btn-default">Изменить</button> <a href="delete-category.php?cat_id='.$cat_id.'"><button class="btn btn-danger">Удалить</button></a></td>';
                                echo "</tr>";
                            }
