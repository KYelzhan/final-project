     ...
     <div class="container" style="margin:8% auto;width:900px;">
         ...
         <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Созданные задания</h3>

                </div> 
                 <div class="panel-body">
                    <a href="add-topic.php" class="pull-right btn btn-success">Добавить</a><br><br>
               <table class="table table-stripped">
                            ...
                            while($row=mysql_fetch_array($run))
                            {
                                ...
                                echo "<td>".$row['category']."</td>";
                                 echo "<td>".
                                    "<a href='topic-details.php?post_Id=$id' class='btn btn-default'>Подробности</a>"." ".
                                    "<a href='edit-topic.php?post_Id=$id' class='btn btn-default'>Изменить</a>"." ".
                                    "<a href='delete-topic.php?post_Id=$id' class='btn btn-default'>Удалить</a>"
                                    ."</td>";
                                echo "</tr>";
                            }
