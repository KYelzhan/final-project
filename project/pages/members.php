...
<head>
  <style>
      body { 
      background: url(..images/5-razones-realizar-email-marketing-mailrelay.gif) no-repeat;
    	...
    	<div class="row"> 
			...
			<div class="col-md-8">
				...
				<?php
					...
					echo 	'<div class="panel panel-success">
								...
								<div class="panel-body">
									<div class="col-md-3 col-lg-3" align="center">
										<img alt="ABATAP" src="'.$avatar.'" style="width: 100px; height: auto;" class="center-block img-responsive img-thumbnail">
									</div>
                    ...
                    <a href="members-info.php?id='.$user_Id
                    .'" class="btn btn-info" style="width:100%;">Подробнее</a>
						      </div>
								</div>
							</div>';
					}
